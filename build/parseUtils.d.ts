...
export declare function isParseSuccess<T>(result: ParseResult<T>): result is ParseSuccess<T>;
export declare function isParseFailure(result: ParseResult<any>): result is ParseFailure;
...
export declare const char: <Char extends string>(c: Char) => Parser<Char>;
...
export declare const oneOf: <ParserArray extends readonly Parser<any>[]>(parsers: ParserArray) => Parser<ParserToken<ParserArray[number]>>;
export declare function sequence<N extends number, ParserArray extends FixedSizeArray<N, Parser<any>>, Delimiter>(parsers: ParserArray, delimiter?: Parser<Delimiter>): Parser<ParserTokenArray<ParserArray>>;
export declare function sequence<N extends number, ParserArray extends Parser<any>[], Delimiter>(parsers: ParserArray, delimiter?: Parser<Delimiter>): Parser<ParserTokenArray<ParserArray>>;
...
export declare const between: <L, T, R>(left: Parser<L>, parser: Parser<T>, right: Parser<R>) => Parser<T>;
export declare const prefix: <P, T>(prefix: Parser<P>, parser: Parser<T>) => Parser<T>;
export declare const suffix: <T, S>(parser: Parser<T>, suffix: Parser<S>) => Parser<T>;
